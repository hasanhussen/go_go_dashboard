...
<div class="container py-4">
    <h4 class="fw-bold mb-4 text-danger">Create New Category</h4>
            ...
            <form action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="type" class="form-control" placeholder="Enter category name" value="{{ old('type') }}" required>
                    </div>
